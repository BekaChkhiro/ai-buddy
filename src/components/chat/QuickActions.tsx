...
import { Lightbulb, Code, FileSearch, Bug, Sparkles, CheckCircle } from "lucide-react";
...
export function QuickActions({ onSelectAction, currentMode, className }: QuickActionsProps) {
  return (
        ...
        {QUICK_ACTIONS.map((action) => (
          ...
          >
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 mt-0.5 text-primary">{action.icon}</div>
